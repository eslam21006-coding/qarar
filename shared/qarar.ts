...
export const RULES: Record<RuleCode, { titleAr: string; defAr: string }> = {
  ...
  NS1: {
    ...
    defAr: "هذه الحملة هدفها التوعية أو جذب الزيارات، لا تُحكم على المبيعات المباشرة — استمر بنفس الميزانية اليومية.",
  },
  NS2: {
    titleAr: "راقب — ميزانية مرتفعة لحملة غير مباشرة",
    defAr: "ميزانية هذه الحملة أعلى من الحد اليومي المسموح للحملات غير المباشرة — قلّلها لتعود إلى المستوى المناسب.",
  },
};
